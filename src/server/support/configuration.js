  ...
  clients: [
    {
      ...
      redirect_uris: [process.env.OIDC_REDIRECT_1, process.env.OIDC_REDIRECT_2, process.env.OIDC_REDIRECT_3, process.env.OIDC_REDIRECT_4, process.env.OIDC_REDIRECT_5, process.env.OIDC_REDIRECT_6 ],
    }
  ],
  scopes: [
    'openid',
